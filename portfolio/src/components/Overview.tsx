...
const overviewCards = [
  {
    ...
    icon: FaLayerGroup,
    accent: 'from-orange-500 to-orange-400 dark:from-teal-500 dark:to-teal-400',
  },
  {
    title: 'How I work',
    text: 'Clear APIs, stable data models, and workflows that stay operable after launch.',
    icon: FaCogs,
    accent: 'from-orange-600 to-orange-500 dark:from-teal-600 dark:to-teal-500',
  },
  {
    title: 'Where to start',
    text: 'Jump into projects, skills, or experience based on what you want to inspect.',
    icon: FaRoute,
    accent: 'from-orange-400 to-orange-600 dark:from-teal-400 dark:to-teal-600',
  },
]

const aiCapabilities = [
  { label: 'LLM Pipelines', desc: 'OpenAI, Gemini, Claude, DeepSeek', icon: FaProjectDiagram, tone: 'teal' },
  { label: 'AI Agents', desc: 'LangGraph, LangChain, HITL workflows', icon: FaCogs, tone: 'teal' },
  { label: 'RAG Systems', desc: 'Vector search, chunking, retrieval', icon: FaDatabase, tone: 'teal' },
  { label: 'Voice & Multimodal', desc: 'Whisper, TTS, document vision', icon: FaMicrophone, tone: 'teal' },
  { label: 'Full Stack', desc: 'React, FastAPI, Next.js, Django', icon: FaCode, tone: 'teal' },
  { label: 'Cloud & DevOps', desc: 'AWS, Railway, Docker, Nginx', icon: FaCloud, tone: 'teal' },
]

const stackLayers = [
  { label: 'Prompt + UI', icon: FaCode, x: 96, y: 96, className: 'border-orange-300/50 bg-orange-50/80 text-orange-900 dark:border-teal-300/40 dark:bg-teal-300/10 dark:text-teal-100' },
  { label: 'Infra', icon: FaDocker, x: 260, y: 68, className: 'border-slate-300/50 bg-slate-100/80 text-slate-800 dark:border-slate-500/40 dark:bg-slate-700/25 dark:text-slate-200' },
  { label: 'Agent Logic', icon: FaBrain, x: 430, y: 118, className: 'border-orange-400/50 bg-orange-50/80 text-orange-900 dark:border-teal-300/40 dark:bg-teal-300/10 dark:text-teal-100' },
  { label: 'Retrieval', icon: FaSearch, x: 112, y: 264, className: 'border-slate-300/50 bg-slate-100/80 text-slate-800 dark:border-slate-500/40 dark:bg-slate-700/25 dark:text-slate-200' },
  { label: 'Documents', icon: FaFileAlt, x: 400, y: 282, className: 'border-orange-300/50 bg-orange-50/80 text-orange-900 dark:border-teal-300/40 dark:bg-teal-300/10 dark:text-teal-100' },
]
    ...
    <div className="grid gap-10">
      <section className="grid gap-6 lg:grid-cols-[0.82fr_1.18fr] lg:items-center">
        ...
        <div className="ice-glass-card relative overflow-hidden rounded-lg border border-slate-200 bg-white p-5 shadow-sm dark:border-white/10 dark:bg-white/5">
          <div className="absolute inset-x-8 top-1/2 hidden h-px bg-gradient-to-r from-transparent via-orange-300/50 dark:via-teal-300/50 to-transparent lg:block" aria-hidden="true" />
            ...
            {overviewCards.map((card, index) => {
              ...
              return (
                <article key={card.title} className="ice-glass-soft relative rounded-lg border border-slate-200 bg-slate-50 p-5 dark:border-white/10 dark:bg-slate-950/50">
                  <div className={`mb-5 flex h-11 w-11 items-center justify-center rounded-lg bg-gradient-to-br ${card.accent} text-white shadow-md`}>
                    <Icon aria-hidden="true" />
                  </div>
                  <span className="text-xs font-medium uppercase tracking-[0.12em] text-slate-400">Step 0{index + 1}</span>
      ...
      <section className="grid gap-6 py-2 lg:grid-cols-[0.95fr_1.05fr] lg:items-start">
        <div className="lg:col-start-1">
            ...
            <h2 className="max-w-3xl text-3xl font-bold leading-tight tracking-tight text-slate-950 dark:text-white sm:text-5xl">
        ...
        <div className="stack-map-panel relative min-h-[360px] overflow-hidden rounded-lg border p-5 shadow-sm lg:col-start-1 lg:row-start-2">
            <div className="relative z-10 flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.12em] text-slate-500 dark:text-slate-400">
              <FaBezierCurve aria-hidden="true" className="text-orange-500 dark:text-teal-400" />
              Stack map
            </div>
            <svg className="absolute inset-0 h-full w-full" viewBox="0 0 520 360" aria-hidden="true">
              <defs>
                ...
                <linearGradient id="stack-route-dark" x1="0" x2="1" y1="0" y2="1">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="stack-core flex h-32 w-32 items-center justify-center rounded-full border border-orange-500/30 bg-orange-100/60 text-orange-950 shadow-2xl shadow-orange-600/10 backdrop-blur dark:border-teal-200/30 dark:bg-teal-300/10 dark:text-teal-100 dark:shadow-teal-400/10">
        ...
        <div className="ice-glass-card overflow-hidden rounded-lg border border-slate-200 bg-white p-4 shadow-sm dark:border-white/10 dark:bg-white/5 lg:col-start-2 lg:row-start-2 lg:row-span-2">
          <div className="mb-4 flex items-center justify-between gap-3">
            <div>
              <p className="text-xs font-semibold uppercase tracking-[0.14em] text-orange-600 dark:text-teal-400">
                Layer cards
              </p>
            ...
            <p className="hidden text-xs font-medium text-slate-400 sm:block">Swipe or scroll</p>
          </div>
          ...
          <p className="mt-2 text-xs font-medium text-slate-400 sm:hidden">Swipe or scroll</p>
        </div>
      </section>
    </div>
  )
